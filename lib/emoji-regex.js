...
var modifierSequence = `${ranges}(?:${modifier})?`;

var zwjSequence = `(?:${modifierSequence}${joiner})*${modifierSequence}`;
...
module.exports = {
    ...
    sequences: new RegExp(`(?:${final})+`, "g"), // Not to be confused with Emoji Sequences. The sequence in this line means sequences of imoticons, Modifier Sequences or ZWJ Sequences in a string.
    sequenceOfSame: new RegExp(`^(${final})\\1*$`)
};
